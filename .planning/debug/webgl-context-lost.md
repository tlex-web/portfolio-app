...
hypothesis: CONFIRMED - Intermediate textures from TextureLoader.load() never disposed after hot-swap
test: Traced full texture lifecycle through both phases
